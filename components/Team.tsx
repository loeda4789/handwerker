    ...
    <section id="team" className="bg-surface dark:bg-dark-secondary py-20">
      <div className="max-w-screen-xl mx-auto px-4">
        ...
        <div className="lg:hidden relative max-w-sm mx-auto">
          ...
          <button
            onClick={prevMember}
            className="absolute left-2 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 z-10 disabled:opacity-30"
          ...
          <button
            onClick={nextMember}
            className="absolute right-2 top-1/2 transform -translate-y-1/2 w-10 h-10 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 z-10 disabled:opacity-30"
            disabled={teamMembers.length <= 1}
        ...
        <div className="mt-20 border-t border-gray-200 dark:border-gray-700 pt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center group">
              <div className="w-16 h-16 mx-auto mb-4 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-700 group-hover:bg-gray-200 dark:group-hover:bg-gray-700 transition-all duration-300">
