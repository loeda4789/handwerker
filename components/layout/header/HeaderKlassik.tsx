        ...
        <div className={`${headerStyles.nav} flex justify-between items-center`}>
          ...
          >
            <div className="relative w-8 h-7 flex flex-col justify-center">
              <span className={`absolute block h-1.5 bg-current rounded-full mobile-nav-animation hamburger-line hamburger-line-1 ${
                isMenuOpen ? 'open' : ''
              }`} style={{ willChange: 'transform, opacity' }}></span>
              <span className={`absolute block h-1.5 bg-current rounded-full mobile-nav-animation hamburger-line hamburger-line-2 ${
                isMenuOpen ? 'open' : ''
              }`} style={{ willChange: 'transform, opacity' }}></span>
              <span className={`absolute block h-1.5 bg-current rounded-full mobile-nav-animation hamburger-line hamburger-line-3 ${
                isMenuOpen ? 'open' : ''
              }`} style={{ willChange: 'transform, opacity' }}></span>
            </div>
          </button>
